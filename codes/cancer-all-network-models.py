...
def get_network(net):
    ...
    net_temp = net_reduced.copy()
    net.iloc[np.where(net['edgeType']==5)[0], -1] = 2
    net_temp.iloc[np.where(net_temp['edgeType']==5)[0], -1] = 3
    net_final = pd.concat([net, net_temp]).drop_duplicates()
