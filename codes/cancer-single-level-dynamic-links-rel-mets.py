...
def run_network_model(f, col_name, net):
    ...
    fig.savefig('../figures/one-celltype-dynamic-net/relative-abundance/add-links-ec-pred-correlation-%s-%s.png' % (f_name, col_name), dpi=300.)
...
plt.savefig('../figures/one-celltype-dynamic-net/relative-abundance/add-links-extracellular-relative-conc-pearsonr.png', dpi=300.)
...
plt.xlabel('Byproduct fraction, f')
plt.ylabel('Cell line')
plt.savefig('../figures/one-celltype-dynamic-net/relative-abundance/add-links-celltype-abundance.png', dpi=300.)
# %%
